...
- [Architecture Decision Document](#table-of-contents)
  ...
  - [Starter Template Evaluation](./starter-template-evaluation.md)
    ...
    - [Evaluated Options](./starter-template-evaluation.md#evaluated-options)
    - [Selected Starter: Vite + React-TS + shadcn/ui v4 (frontend) · FastAPI + uv (backend)](./starter-template-evaluation.md#selected-starter-vite-react-ts-shadcnui-v4-frontend-fastapi-uv-backend)
    - [Initialization Sequence](./starter-template-evaluation.md#initialization-sequence)
    - [Architectural Decisions Established by This Starter](./starter-template-evaluation.md#architectural-decisions-established-by-this-starter)
